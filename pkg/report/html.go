...
type ReportData struct {
	...
	// ToolVersion is the EUChainGuard tool version string.
	ToolVersion string
...
<title>EUChainGuard CRA Compliance Report - {{.ProjectName}} {{.ProjectVersion}}</title>
<style>
...
<footer>
  Generated by EUChainGuard {{.ToolVersion}} - Open-source CRA/eIDAS SBOM toolchain.<br>
